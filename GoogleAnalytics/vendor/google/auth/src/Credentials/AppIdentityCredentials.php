...
namespace GoogleAnalytics\Auth\Credentials;
 ...
 */
use GoogleAnalytics\appengine\api\app_identity\AppIdentityService;
 ...
 *
 *   use GoogleAnalytics\Auth\Credentials\AppIdentityCredentials;
 *   use GoogleAnalytics\Auth\Middleware\AuthTokenMiddleware;
...
class AppIdentityCredentials extends CredentialsLoader
{
    ...
    public function fetchAuthToken(callable $httpHandler = null)
    {
        ...
        if (!class_exists('GoogleAnalytics\appengine\api\app_identity\AppIdentityService')) {
            throw new \Exception(
