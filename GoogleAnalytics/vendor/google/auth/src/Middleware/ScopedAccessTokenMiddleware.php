...
namespace GoogleAnalytics\Auth\Middleware;

use GoogleAnalytics\Auth\CacheTrait;
use GoogleAnalytics\Auth\FetchAuthTokenInterface;
...
class ScopedAccessTokenMiddleware
{
     ...
     *   use GoogleAnalytics\Auth\Middleware\ScopedAccessTokenMiddleware;
     ...
     *       $scope,
     *       [ 'prefix' => 'GoogleAnalytics\Auth\ScopedAccessToken::' ],
     *       $cache = new Memcache()
     *   );
