...
use GoogleAnalytics\Auth\ApplicationDefaultCredentials;
use GoogleAnalytics\Auth\CredentialsLoader;
use GoogleAnalytics\Auth\HttpHandler\HttpHandlerFactory;
use GoogleAnalytics\Auth\OAuth2;
use GoogleAnalytics\Auth\Credentials\ServiceAccountCredentials;
use GoogleAnalytics\Auth\Credentials\UserRefreshCredentials;
...
class Google_Client
{
  ...
  /**
   * @var GoogleAnalytics\Auth\OAuth2 $auth
   */
  private $auth;
  ...
  /**
   * @return GoogleAnalytics\Auth\OAuth2 implementation
   */
  ...
  /**
   * @return GoogleAnalytics\Auth\CacheInterface Cache implementation
   */
